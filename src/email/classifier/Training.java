...
import email.classifier.Form.Console;
import java.io.File;
...
public class Training {
    ...
    *************************************************/
    ...
    /*************************************************
     * Xoá các dấu thừa thải trong văn bản.
     * @param sentence la 1 văn bản
     * @return văn bản đã được lọc bỏ
    *************************************************/
    public static String removeAllBreakLine(String str){
        // thay break line thành space
        str = str.replace("\r\n", " ");
        str = str.replace("\n", " ");
        str = str.replace("\r", " ");
        // thay tab thành space
        str = str.replace("\t", " ");
        // xoá các dấu đặc biệt
        str = str.replaceAll("/!|@|%|\\^|\\*|\\(|\\)|\\+|\\=|\\<|\\>|\\?|\\/|,|\\.|\\:|\\;|\\'|\\\"|\\&|\\#|\\[|\\]|~|\\$|_|`|-|\\{|\\}|\\||\\\\/g", "");
        // xoá dấu cách thừa thải
    ...
    *************************************************/
    public static void collectKeywords(File folderPath , ArrayList<Set<String>> KeywordCollection) throws IOException
    {
        ...
        for(File element : filenames)
        {
            ...
            // xử lý dữ liệu đưa vào, xoá tất cả dấu xuống dòng, tab, xoá dấu cách thừa thãi,...
            String elemenetContenAfterHandle = removeAllBreakLine(elementContent);
            
            // lấy từng chữ cho vào collection trong nội dung file
            Set<String> collection = seperateSentenceToWords(elemenetContenAfterHandle);
